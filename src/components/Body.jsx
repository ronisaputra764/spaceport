        ...
        <div id="portfolio" className="z-10 flex flex-col mt-20 lg:mt-96 lg:w-[80%] mx-auto">
            <div className="text-center mb-5 sm:mb-10">
                <AnimatedContent
                    ...
                    threshold={0}
                >
                    <h1 className="bg-clip-text inline mx-3 w-full text-4xl md:text-5xl poppins-semibold bg-gradient-to-r text-transparent from-purple-500 to-cyan-500 [text-shadow:0_0_500px_#7042F88B,0_0_100px_#a855f7]">Portfolio Showcase</h1>
                </AnimatedContent>
