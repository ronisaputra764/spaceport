...
export default function DesktopHeader() {
    return (
        ...
        >
            <div className="h-full text-[#c9c1e3] flex-col gap-5 justify-center grid grid-cols-2 mt-44 text-start">
                ...
                <div className="mt-32">
                    ...
                    <AnimatedContent
                        ...
                        threshold={0}
                    >
                        <div className="mb-4 border rounded-full py-[8px] px-[12px] opacity-[0.9] inline-block border-[#7042F88B] shadow-[inset_-5px_-5px_10px_0_rgba(59,130,246,0.3)]">
                    ...
                    <AnimatedContent
                        ...
                        threshold={0.2}
                    >
                        <h1 className="bg-clip-text inline w-full text-7xl poppins-semibold bg-gradient-to-r text-transparent from-purple-500 to-cyan-500 [text-shadow:0_0_500px_#7042F88B,0_0_100px_#a855f7]">Roni Saputra</h1>
                    </AnimatedContent>
                    ...
                    >
                        <div className="flex gap-3 mt-4">
                            <a className="flex items-center bg-white/5 border border-gray-700 hover:cursor-pointer text-sm py-2 px-4 rounded-full">
                                <span>React</span>
                            </a>
                            <a className="flex items-center bg-white/5 border border-gray-700 hover:cursor-pointer text-sm py-2 px-4 rounded-full">
